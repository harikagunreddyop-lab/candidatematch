  ...
  return (
    <div className="space-y-8 max-w-2xl">
      <div>
        ...
        <p className="admin-page-subtitle">Feature flags, defaults, and matching engine controls.</p>
      </div>
      ...
      <div className="card p-4 sm:p-6 space-y-5">
        ...
        <p className="text-xs text-surface-500">These are global toggles that disable features for all candidates (overrides per-user settings).</p>
        <div className="space-y-4">
          {Object.entries(FEATURE_DEFAULTS).map(([key, def]) => (
            <label key={key} className="flex items-center justify-between gap-4 cursor-pointer">
              <span className="text-sm text-surface-700">{def.label}</span>
              <input
                type="checkbox"
    ...
    <div className="card p-4 sm:p-6 space-y-5">
      <div>
        ...
        <p className="text-xs text-surface-500 mt-1">
          Recomputes P(interview) from outcome data. Requires <code className="text-xs bg-surface-100 px-1 rounded">elite.calibration</code> feature flag.
        </p>
      </div>
  ...
  return (
    <div className="card p-4 sm:p-6 space-y-5">
      ...
      <div className="flex items-center gap-2 px-3 py-2 rounded-xl bg-emerald-50 border border-emerald-200 w-fit">
        ...
        <span className="text-xs font-semibold text-emerald-700">Active — runs daily at 3 AM UTC</span>
      </div>
      ...
      <div className="space-y-4">
        ...
        <div className="flex items-center justify-between gap-4">
          <div>
            <p className="text-sm font-medium text-surface-700">Stale threshold</p>
