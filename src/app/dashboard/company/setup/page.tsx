...
function ActionCard({
  ...
  return (
    <button
      type="button"
      onClick={onClick}
      className="rounded-2xl border border-surface-700 bg-surface-800/80 p-6 text-left hover:border-brand-400/50 hover:bg-surface-800 transition-all group"
    >
      <div className="w-12 h-12 rounded-xl bg-brand-400/20 text-brand-400 mb-4 group-hover:bg-brand-400/30">
        {icon}
      </div>
