...
export default function RecruiterJobDetailPage() {
  ...
  return (
    <div className="max-w-4xl mx-auto px-4 sm:px-6 py-8 space-y-6">
      ...
      <Link href={`/dashboard/recruiter/jobs/${jobId}/candidates`} className="flex items-center gap-3 p-4 rounded-xl border border-surface-700 bg-surface-100 hover:bg-surface-700/50 transition-colors">
