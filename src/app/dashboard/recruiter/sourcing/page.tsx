      ...
      <div className="mb-6">
        <div className="relative">
          ...
          <input
            ...
            className="w-full pl-12 pr-4 py-3 bg-surface-800 border border-surface-700 rounded-lg text-white placeholder:text-surface-500 focus:outline-none focus:ring-2 focus:ring-violet-500/50"
          />
        </div>
      </div>
      ...
      <div className="bg-violet-500/10 border border-violet-500/20 rounded-xl p-6 mb-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
          <Link
            ...
            className="rounded-lg border border-surface-700 bg-surface-800/80 p-4 hover:border-violet-500/30 transition-colors"
          >
