...
const CANDIDATE_PLANS = [
  ...
  },
  {
    ...
    features: [
      ...
      'Up to 40 applications per day',
      'Up to 5 resume uploads',
      '10 AI resume generations per week',
      'Full ATS breakdown & missing keywords',
      'Resume tailoring & downloads',
      'Application analytics & recruiter visibility',
    ],
    cta: 'Upgrade to Pro',
    popular: false,
  ...
  },
  {
    ...
    features: [
      'Everything in Pro',
      'Up to 80 applications per day',
      'Up to 10 resume uploads',
      'Unlimited AI resume generations',
      'Bulk apply & auto-apply tools',
      'Priority matching & recruiter visibility',
      'Advanced analytics & interview insights',
      'Resume coaching sessions (on demand)',
    ],
    cta: 'Most popular · Go Pro Plus',
    popular: true,
  ...
  },
  {
    ...
    features: [
      ...
      'Featured recruiter visibility',
      '1:1 dedicated career advisor',
      'Hands-on resume & interview coaching',
      'Warm recruiter introductions',
      'White-glove priority support',
    ],
    cta: 'Apply for Elite',
    popular: false,
    // Maps to enterprise tier on the backend
