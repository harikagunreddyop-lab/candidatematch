      ...
      <div className="flex items-start justify-between gap-3 flex-wrap">
        <div>
          ...
          <p className="text-sm text-surface-500 dark:text-surface-400 mt-1">
            Use <strong>Sync all</strong> or per-connector <strong>Sync</strong> to refresh jobs. To run on a schedule, configure an external scheduler (e.g. AWS EventBridge) to call <code className="text-xs">/api/cron/ingest</code>.
          </p>
        </div>
